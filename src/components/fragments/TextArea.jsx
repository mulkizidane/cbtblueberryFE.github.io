...
<div className="max-w-2xl border-2 border-neutral-500">
    ...
    <div className="w-full bg-gray-50 border border-gray-200 dark:bg-gray-100">
        <div className="flex justify-between items-center py-2 px-3 border-b dark:border-gray-300">
        ...
        <div className="py-2 px-4 bg-white dark:bg-gray-300">
            ...
            <textarea id="editor" rows={rows ? rows : '8'} className="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-300 focus:ring-0 dark:text-black dark:placeholder-gray-400" placeholder="Write your answer..." required></textarea>
        </div>
    </div>
    </form>
